...
public class MockOpenStreetMap extends MockVisibleComponent{
  /**
   * Component type name.
   */
  public static final String TYPE = "OpenStreetMap";

  // Large icon image for use in designer. Smaller version is in the palette.
  private final Image largeImage = new Image(images.openStreetMapBig());


  public MockOpenStreetMap(SimpleEditor editor){
    super(editor, TYPE, images.openStreetMap());
